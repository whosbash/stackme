...
categories_to_stacks=(
  ...
  ["Data Storage"]="supabase clickhouse redis pgvector iceberg minio mysql mariadb baserow postgres mongodb weaviate qdrant chromadb"
  ...
  ["ERP"]="odoo"
  ["AI"]="affine ollama anythingllm woofed langflow langfuse boltai"
...
declare -A stack_descriptions=(
  ...
  ["boltai"]="A platform for deploying AI models with ease."
  ["chromadb"]="A platform for managing and analyzing genomic data."
  ["clickhouse"]="A columnar database for online analytical processing (OLAP)."
  ["firecrawl"]="A web scraping API for crawling and extracting data from websites."
